...
import { fetchWorkoutTemplateById } from '../../api/WorkoutTemplateApi';
import Snackbar from '@mui/material/Snackbar';

export default function CreatePlanFromTemplate() {
  ...
  const workoutTemplateId = location.state.templateId || {};
  ...
  const getWorkoutPlanDetails = () =>{
    fetchWorkoutTemplateById(workoutTemplateId)
    .then((res) =>{
  ...
  const handleUpdate = () => {
    ...
    .then((res) =>{
        ...
        console.log("WorkoutPlan Create Failed!")
    })
    localStorage.removeItem('workoutPlanRows');
